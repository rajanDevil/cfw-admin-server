...
exports.add = (param) => {
	...
	if(param.image){
		...
		var filePath = "http://52.200.24.125/cfw-admin-server/client/public/uploads/"+fileName;
		var uploadPath = "http://52.200.24.125/cfw-admin-server/client/public/uploads/"+fileName;
