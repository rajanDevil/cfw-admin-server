...
const vendorReturnsShow = props => (
    <Show {...props}>
        <SimpleForm>
            <TextField source="id" key/>
            <ReferenceField label="Purchase ID" source="purchase_id" reference="purchases">
                <ChipField source="id" />
            </ReferenceField>
            ...
            {/* <AddvendorReturnsButton /> */}
        </SimpleForm>
    </Show>
  );

  export default vendorReturnsShow;