...
import VendorReturnsFilter from './VendorReturnsFilter'
...
const LinkedPurchaseChips = ({record, source}) =>{
  const theRecord = record[source];
  const { data } = useGetOne('purchases', theRecord);
...
const vendorReturnsList = props => (
    <List filters={<VendorReturnsFilter />} {...props}>
        <Datagrid>
            ...
            <LinkedPurchaseChips source="purchase_id" label="Purchase ID"/>
...
export default vendorReturnsList;
